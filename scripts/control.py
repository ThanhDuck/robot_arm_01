...
For controlling the robot arm joints:
---------------------------
   7 : Increase joint 1 position by 0.01 rad
   1 : Decrease joint 1 position by 0.01 rad
   9 : Increase joint 2 position by 0.01 rad
   3 : Decrease joint 2 position by 0.01 rad
   5 : Reset both joints to home position (joint 1 = 0, joint 2 = 0)
...
class PublishThread(threading.Thread):
    ...
    def update(self, x, y, z, th, speed, turn, joint_1_pos, joint_2_pos):
    ...
    def run(self):
        ...
        while not self.done:
            ...
            self.joint_1_pub.publish(Float64(self.joint_1_pos))
            self.joint_2_pub.publish(Float64(self.joint_2_pos))
...
if __name__ == "__main__":
    ...
    try:
        ...
        pub_thread.update(x, y, z, th, speed, turn, joint_1_pos, joint_2_pos)
        ...
        while(1):
            ...
            if key in moveBindings.keys():
                ...
                joint_2_pos -= 0.01
            elif key == '5':  # Reset to home position
                joint_1_pos = 0.0
                joint_2_pos = 0.0
            else:
